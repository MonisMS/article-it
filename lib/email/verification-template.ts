export function buildVerificationEmail(opts: {
  ...
  const subject = "Verify your ArticleIt email address"
    ...
    <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#ffffff;border:1px solid #e4e4e7;border-radius:12px;overflow:hidden;">
      ...
      <tr>
        <td style="padding:32px 32px 8px;">
          <h1 style="margin:0 0 8px;font-size:20px;font-weight:700;color:#09090b;">Hey ${firstName}, confirm your email</h1>
